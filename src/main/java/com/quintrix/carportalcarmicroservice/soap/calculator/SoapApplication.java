 ...
 * 
 * @SpringBootApplication public class SoapApplication implements CommandLineRunner {
 * 
 * 
 * 
 ...
 * 
 * // This prints directly to terminal. We can delete this is we choose not to use it Calculator
 * calcService = new Calculator(); CalculatorSoap calculatorSoapProxy =
 * calcService.getCalculatorSoap(); System.out.println(calculatorSoapProxy.add(7, 5));
 * 
 * }
 */
